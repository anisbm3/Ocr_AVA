...
This app requires the Tesseract OCR engine for `ocr_box` mode.

1. Install:
   - Windows: https://github.com/tesseract-ocr/tesseract/wiki
   - macOS: `brew install tesseract`
   - Linux: `sudo apt update && sudo apt install tesseract-ocr`
2. Ensure the `tesseract` executable is in your `PATH`.
3. (Optional) Install language packs if you need non-English OCR.
